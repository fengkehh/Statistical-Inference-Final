...
```{r panel_plot, fig.cap = 'Mean tooth length from each supplement type and dosage.'}
...
```{r limited_t_test, tidy = FALSE, fig.cap = 'Log of P-values from one-sided T-test (x > y) between VC 2 and other groups. Cutoff at P-value = log(0.05) is drawn as the red line.'}
